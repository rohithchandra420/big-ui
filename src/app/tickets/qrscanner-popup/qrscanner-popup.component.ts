...
export class QrscannerPopupComponent {
  ...
  constructor(private qrcode: NgxScannerQrcodeService,
    public dialogRef: MatDialogRef<QrscannerPopupComponent>,
  ...
  public onEvent(e: ScannerQRCodeResult[], action?: any): void {
    ...
    try {
      ...
      this.validKeys = keys.includes("_id") && keys.includes("oid") && keys.includes("tid");
      if (this.validKeys) {
